...
public class DriverHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        driverHistoryAdapter = new DriverHistoryAdapter(tripList);
    ...
    private void loadDriverHistory() {
        // מושך את כל הנסיעות שבהן uidDriver == currentUserID
        tripsDatabase.orderByChild("uidDriver").equalTo(currentUserID)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(DriverHistoryActivity.this,
                                "Failed to load driver history.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    @Override
